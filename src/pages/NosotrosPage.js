    ...
    return (
        <section className="holder">
            <div className="historia">
                <h2>Nosotros</h2>
                <div className="imgnosotros"><img src="images/desk.jpg" width="60%" /></div>
            ...
            <div className="contenedorstaff">
                <div className="staff">
                    <img className="cara" src="images/cara1.jpg" width="75" />
                ...
                <div className="staff">
                    <img className="cara" src="images/cara2.jpg" width="75" />
                ...
                <div className="staff">
                    <img className="cara" src="images/cara3.jpg" width="75" />
                ...
                <div className="staff">
                    <img className="cara" src="images/cara4.jpg" width="75" />
